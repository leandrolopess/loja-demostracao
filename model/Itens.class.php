...
class Itens extends Conexao{
     ...
     private $total_valor, $total_pedido;
    ...
    function GetItensPedido($pedido, $cliente=null){
       ...
       private function GetLista(){
        ...
        $sub = $lista['item_valor'] * $lista['item_qtd'];
        $frete = $lista['ped_frete_valor'] + $sub;
        $this->total_pedido += $frete;
        ...
        'ped_frete_valor_br' => Sistema::MoedaBR($lista['ped_frete_valor']),
        'ped_frete_tipo'  => $lista['ped_frete_tipo'],
        'item_id'  => $lista['item_id'],
        'item_nome'  => $lista['pro_nome'],
        'item_pro_id'  => $lista['pro_id'],
        // 'item_pro_qtd'  => $lista['pro_qtd'],
