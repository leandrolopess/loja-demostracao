				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form method="post">
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							...
							<img style="width:22px;height:18px;" class="how-pos4 pointer-none" src="{$GET_TEMA}/assets/images/icons/user.png" alt="Nome">
						</div>

						<div class="bor8 m-b-20 how-pos4-parent"> 
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text"  name="email" placeholder="Email*" required>
							<img class="how-pos4 pointer-none" src="{$GET_TEMA}/assets/images/icons/icon-email.png" alt="Email">
						</div>
				...
				<div class="size-210 bor10 flex-w flex-col-m p-lr-93 p-tb-30 p-lr-15-lg w-full-md">
					...
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl6 p-t-18">
								{$I.info_rua}, {$I.info_numero} <br>{$I.info_cidade}, {$I.info_estado} <br>{$I.info_cep}
							</p>
						</div>
					</div>
					...
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 size-213 p-t-18">
								<a class="azul" href="tel:{$INFO.1.info_telefone}">{$I.info_telefone}</a>
							</p>
						</div>
					</div>
					...
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 size-213 p-t-18">
								<a class="azul" href="tel:{$INFO.1.info_telefone}">{$I.info_whats}</a>
							</p>
						</div>
					</div>
					{/foreach}
					...
					<div class="flex-w w-full">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl1 size-213 p-t-18">
								<a class="azul" href="mailto:{$INFO.1.info_email}">{$INFO.1.info_email}</a>
							</p>
						</div>
					</div>
				</div>
