...
<html lang="pt-br">
<head>
<title>Vanuza - {$BLOG.1.blog_titulo}</title>
<meta charset="UTF-8">
...
<!--===============================================================================================-->
	...
	<link rel="stylesheet" type="text/css" href="{$GET_TEMA}/assets/blog/css/blog.css"><link rel="stylesheet" type="text/css" href="{$GET_TEMA}/assets/blog/css/responsive.css">
