...
<section class="row" id="cadastro">
      ...
      <input title="* Nome" value="{$NOME}" class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="cli_nome" placeholder="* Nome" minlength="3" required>
      </div>
        </div>
    ...
    <input title="* DDD" class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="cli_ddd" placeholder="* DDD" minlength="2" maxlength="2" required>
        ...
        <div class="bor8 m-b-20 how-pos4-parent">
    <input title="Telefone" class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="cli_fone"  maxlength="8" placeholder=" Telefone">
      </div>  
        </div>
        ...
        <div class="col-lg-4 col-md-6">
          <label>Celular</label>
        <div class="bor8 m-b-20 how-pos4-parent">
    <input title="* Celular" class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="cli_celular" minlength="9" maxlength="9"  placeholder="* Celular" required>
      </div> 
        </div>
...
<section class="row" id="cadastro">
        <div class="col-md-12">
        <p class="margin-bottom alert alert-warning">A confirmação e o acompanhamento de seu pedido serão enviados ao seu e-mail</p> 
        </div>

        <div class="col-lg-12 col-md-12">
          <label>Nome de usúario</label>
        <div class="bor8 m-b-20 how-pos4-parent">
    <input title="* Nome de usúario" class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="cli_user_name" minlength="2" placeholder="* Nome de usuário" required>
      </div>
        </div>
        ...
        <div class="col-lg-12 col-md-12">
          <label>Email</label>
        <div class="bor8 m-b-20 how-pos4-parent">
    <input title="* Email" class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="email" name="cli_email" value="{$EMAIL}" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" oninvalid="setCustomValidity('Email invalido. O Email precisa conter no mínimo um @ e um ponto(.) no endereço')" oninput="setCustomValidity('')" placeholder="* Email" required>
      </div>
        </div>
    ...
    <input type="checkbox" class="form-check-input" id="exampleCheck1" style="position: relative;left: 15px;top: 21px;">
    <label class="form-check-label f-14" for="exampleCheck1">Quero receber por email ofertas e novidades da {$SITE_NOME}. </label>
  </div>
  </div>
