<?php
/* Smarty version 3.1.34-dev-7, created on 2019-12-08 20:21:04
  from 'D:\xampp\htdocs\loja_adaptada\add\view\add_produtos_novo.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5ded7750c15832_91352628',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ef5d754cd73801c50338c06aae92bfcf8f41a064' => 
    array (
      0 => 'D:\\xampp\\htdocs\\loja_adaptada\\add\\view\\add_produtos_novo.tpl',
      1 => 1575843660,
      2 => 'file',
    ),
  ),
...
function content_5ded7750c15832_91352628 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/assets/js/ckeditor5/ckeditor.js"><?php echo '</script'; ?>
> 
...
" class="stext-109 cl8 hov-cl1 trans-04">
  ...
  <div class="col-md-12 margin-top"> 
   <h1 class="cl2 mtext-105"> <i class="fa fa-plus"></i> Adicionar novo produto
   </h1>
...
<section class="row" id="camposproduto">
     ...
     <div class="m-b-30">
    <!--   <textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25 no-resize" name="pro_desc" id="editor" placeholder="Descrição do produto*" required></textarea> -->
    <!--   <?php echo '<script'; ?>
> 
...
>
      ...
      <input title="* Preço do Produto" class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="pro_valor" placeholder="* Preço do Produto" required>
        ...
        <div class="bor8 m-b-20 how-pos4-parent">
      <input title="* Porcentagem do desconto" class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="pro_desconto" placeholder="ex. 5, 10, 15, 20" >
      </div>
        </div>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
      ...
      <label for="pro_img"><h5 class="text-center">800x800<br>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
      ...
      <input type="hidden" name="pro_slug">
