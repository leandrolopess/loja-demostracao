<?php
/* Smarty version 3.1.34-dev-7, created on 2019-12-11 15:39:31
  from 'D:\xampp\htdocs\vanuza\add\view\add_editar_banner.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5df129d31307e5_47032890',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7b2ab7ec8387b4c5325144efb9e2f61a390c887b' => 
    array (
      0 => 'D:\\xampp\\htdocs\\vanuza\\add\\view\\add_editar_banner.tpl',
      1 => 1576085968,
      2 => 'file',
    ),
  ),
...
function content_5df129d31307e5_47032890 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
<section class="row" id="camposproduto">
      ...
      <input title="* Titulo do banner" class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="banner_titulo" value="<?php echo $_smarty_tpl->tpl_vars['BANNER']->value[1]['banner_titulo'];?>
" required>
      </div>
        </div>
     ...
     <div class="m-b-30">
      <textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25 no-resize" name="banner_descricao" id="banner_descricao" required><?php echo $_smarty_tpl->tpl_vars['BANNER']->value[1]['banner_descricao'];?>
</textarea>
      <?php echo '<script'; ?>
> 
...
/media/banners/<?php echo $_smarty_tpl->tpl_vars['BANNER']->value[1]['banner_img'];?>
...
">
        ...
        <div class="col-md-12"> 
         <label>Ordem</label>
        <div class="bor8 m-b-20 how-pos4-parent">
      <input title="* Ordem de exibição do banner" class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="banner_ordem" value="<?php echo $_smarty_tpl->tpl_vars['BANNER']->value[1]['banner_ordem'];?>
" required>
      </div>
        </div>
        ...
        <input type="hidden" name="pro_id" value="<?php echo $_smarty_tpl->tpl_vars['BANNER']->value[1]['banner_id'];?>
">
      </div>
        </form>
        ...
        <div class="modal fade" id="Modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <input type="hidden" name="banner_id_apagar" value="<?php echo $_smarty_tpl->tpl_vars['BANNER']->value[1]['banner_id'];?>
">
