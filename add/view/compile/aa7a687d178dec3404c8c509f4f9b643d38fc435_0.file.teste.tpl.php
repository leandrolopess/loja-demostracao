<?php
/* Smarty version 3.1.33, created on 2019-10-18 22:46:39
  from 'D:\xampp\htdocs\loja\view\teste.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5daa24af011cc5_16969761',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'aa7a687d178dec3404c8c509f4f9b643d38fc435' => 
    array (
      0 => 'D:\\xampp\\htdocs\\loja\\view\\teste.tpl',
      1 => 1571431595,
      2 => 'file',
    ),
  ),
...
function content_5daa24af011cc5_16969761 (Smarty_Internal_Template $_smarty_tpl) {
?>   <article class="text col-lg-9 col-md-9 man-article">
        <header>
  <h1>Formulários</h1>
  <h2>Fazendo máscaras para formulários como CPF, datas e outros tipos.</h2>
</header>
...
<pre class="lang-html prettyprint-code linenums">
...
<h3>Definindo as mascaras no HTML.</h3>
<p>Você pode criar máscaras para os seus campos editando o atributo <code>data-mask</code>, veja o exemplo abaixo:</p>
<div class="example">
  <form role="form">
    <fieldset>
      <div class="row">
        <div class="form-group col-lg-4">
          <label for="example-input-10">Data</label>
          <input type="text" class="form-control" id="example-input-10" placeholder="Ex.: dd/mm/aaaa" data-mask="00/00/0000">
        </div>
      </div>
    </fieldset>
  </form>
</div>
<pre class="lang-html prettyprint-code linenums"><input type="text" class="form-control" placeholder="Ex.: dd/mm/aaaa" data-mask="00/00/0000"></pre>
      </article>
    </div>

  </section>
  <!-- END post content --><?php }
}
