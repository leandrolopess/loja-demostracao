...
<div class="col-md-12 text-center margin-top">
 ...
 <div class="col-md-4"></div>
    <div class="col-md-4 margin-bottom">  
      <a href="{$PAG_PRODUTO_NOVO}" class="btn btn-success"> <i class="fa fa-plus"></i> Novo Produto</a>
    </div>
    <div class="col-md-4"></div>
   ...
   <table class="table  table-hover">
     ...
     {foreach from=$PRO item=P}
       <tr>
        ...
        <button><img src="{$P.pro_img_p}" alt="" width="100px"></button>
        </form>
        </td>
        ...
        <form name="proeditar" method="get" action="{$PAG_PRODUTO_EDITAR}">
        <input type="hidden" name="pro_id" id="pro_id" value="{$P.pro_id}">
        <button>{$P.pro_nome}</button>
        </form>
        </td>

        <td style="width:10%;" class="text-center">R$ {$P.pro_valor}</td>

        <td style="width:10%;" class="text-center">{$P.pro_views}</td>
       ...
       <td style="width:10%;" class="text-center">
       <form name="ver_produto" method="post" action="{$GET_SITE_HOME}/produto/{$P.pro_id}/{$P.pro_slug}" target="_blank">
        <input type="hidden" name="produto_subcategoria" value="{$P.pro_categoria}">
